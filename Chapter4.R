...
# Preparing group with manic symptoms
## covariances
...
# combine the groups: covariance matrices, sample sizes, and means into single list objects
...
# Configural invariance (combined group)
